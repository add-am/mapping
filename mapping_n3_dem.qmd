...
A second important file is the Queensland outline polygon. **Note: This file 
should also already be present in the data folder, Don't change the name.** If 
required, you can find qld polygons online, the exact source does not matter.
