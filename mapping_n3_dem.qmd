...
for (i in 1:length(names)){
  ...
  n3_dem_base_map(dem = gbr, region = target, zscale = 30, sealevel = -10, highlight = T, rivers = T, preload = T)
...
plot_3d(base_map_Mackay_Whitsunday_Isaac, dem_matrix_Mackay_Whitsunday_Isaac, zscale = 30, soliddepth = min(dem_matrix_Mackay_Whitsunday_Isaac)-200,
        water = F, background = "white", shadowcolor = "grey50", 
        shadowdepth = min(dem_matrix_Mackay_Whitsunday_Isaac)-400, theta = 90, phi = 32, zoom = 0.40, fov = 28, 
...
render_label(dem_matrix_Mackay_Whitsunday_Isaac, lat = town_names_Mackay_Whitsunday_Isaac[6,3], long = town_names_Mackay_Whitsunday_Isaac[6,2], 
             extent = location_extent_Mackay_Whitsunday_Isaac, altitude=9000, zscale=10, 
             linewidth = 3, linecolor = "white", textsize = 1.5, text = town_names_Mackay_Whitsunday_Isaac[6,1])
#labels come in sets of 2 to create a black outline on the markers
render_label(dem_matrix_Mackay_Whitsunday_Isaac, lat = town_names_Mackay_Whitsunday_Isaac[6,3], long = town_names_Mackay_Whitsunday_Isaac[6,2], 
             extent = location_extent_Mackay_Whitsunday_Isaac, altitude=9000, zscale=10, 
             text = town_names_Mackay_Whitsunday_Isaac[6,1], textalpha = 0, linewidth = 6)

render_label(dem_matrix_Mackay_Whitsunday_Isaac, lat = town_names_Mackay_Whitsunday_Isaac[311,3], long = town_names_Mackay_Whitsunday_Isaac[311,2], 
             extent = location_extent_Mackay_Whitsunday_Isaac, altitude=12000, zscale=10, 
             linewidth = 3, linecolor = "white", textsize = 1.5, text = town_names_Mackay_Whitsunday_Isaac[311,1])
#labels come in sets of 2 to create a black outline on the markers
render_label(dem_matrix_Mackay_Whitsunday_Isaac, lat = town_names_Mackay_Whitsunday_Isaac[311,3], long = town_names_Mackay_Whitsunday_Isaac[311,2], 
             extent = location_extent_Mackay_Whitsunday_Isaac, altitude=12000, zscale=10, 
             text = town_names_Mackay_Whitsunday_Isaac[311,1], textalpha = 0, linewidth = 6)
...
render_snapshot(filename = glue("{save_path}_Mackay-Whitsunday-Isaac_3D-final-map"))
