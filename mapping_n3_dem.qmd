...
#pull up the plot
plot_3d(base_map_DT, dem_matrix_DT, zscale = 30, soliddepth = min(dem_matrix_DT)-200,
        water = F, background = "white", shadowcolor = "grey50", 
        shadowdepth = min(dem_matrix_DT)-400, theta = 90, phi = 35, zoom = 0.47, fov = 16, 
        windowsize = c(50, 50, 1920, 1080))

#run the function
save_3dprint("tester.stl", maxwidth = 4, unit = "in")
