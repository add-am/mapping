...
## Establishing Dry Tropics Estuarine Boundaries
...
## Establishing Dry Tropics 50m Estuarine Waterway Buffer
...
tm_shape(mulgrave.russell_water) +
  tm_polygons(border.col = "red")
...
We then do some minor data cleaning, and group rows by RE type
...
Now we can calculate the area of each group of RE types and create a summary table.
